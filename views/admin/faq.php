...
if(isset($_POST['submit']) && CSRF::validateToken($_POST['token'])) {
    ...
    if(isset($_POST['answer'])) {
        $statement = $pdo->prepare("UPDATE faq SET repondre=? WHERE id=?");
...
<div class="container">
    <div class="page-title">
        <h3>FAQ
        <a href="./create-faq.php" class="btn btn-sm btn-outline-primary float-end"><i class="fas fa-plus"></i> Ajouter</a>
        </h3>
    </div>
    <?php if($edit): ?>
        <div class="card">
            <div class="card-header">Modifier la FAQ</div>
            <div class="card-body">
                <form accept-charset="utf-8" method="post" action="<?= $_SERVER['REQUEST_URI'] ?>">
                    ...
                    <div class="mb-3">
                        <textarea style="resize:none" name="answer" placeholder="Répondre" class="form-control" rows="3"><?= $data[0]['repondre'] ?></textarea>
                    </div>
                    <div class="mb-3">
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <form action="<?= $_SERVER['REQUEST_URI'] ?>" method="post">
                                            ...
                                            <a href="./faq.php?id=<?= $faq['id']; ?>" class="btn btn-outline-info btn-rounded"><i class="fas fa-pen"></i></a>
