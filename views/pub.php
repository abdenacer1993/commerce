...
//     }
    ...
    $statement = $pdo->prepare("SELECT * FROM pub where id_investisseur=$id_investor");
    $statement->execute();
    if($statement->rowCount() > 0) {
        $items = $statement->fetchAll(PDO::FETCH_ASSOC);
    }
...
<div class="container">
    <div class="page-title">
        <h3>pub
        <a href="./create-pub.php" class="btn btn-sm btn-outline-primary float-end"style="    float: inline-end;"><i class="fas fa-plus"></i> Ajouter</a>
        </h3>
    </div>
    <?php if($edit): ?>
        <div class="card">
                ...
                <div class="col-md-6">
                    <form action="./pub.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3 text-end">
                            ...
                            <input type="text" name="id_investor" value="<?= $items[0]['id_investisseur'] ?>" hidden>
                            <input type="text" name="dateadd" value="<?= $items[0]['dateajout'] ?>" hidden>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <form action="./pub.php" method="post">
                                            ...
                                            <button name="delete" type="submit" class="btn btn-outline-danger btn-rounded"><i class="fas fa-trash"></i>Delete</button>
                                        </form>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
